...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col justify-start md:justify-center px-4 md:px-12 pt-32 md:pt-0 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <div className="space-y-4 md:space-y-6">
            <motion.h2 custom={1} variants={fadeUpVariant} className="text-zinc-400 text-lg md:text-2xl font-light tracking-wide flex items-center gap-4">
              <span className="w-6 md:w-8 h-[1px] bg-cyan-500/50"></span>
