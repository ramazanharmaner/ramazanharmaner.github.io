      ...
      <div className="max-w-7xl mx-auto flex h-16 md:h-20 items-center justify-between px-4 md:px-8">
        <Link href="/" className="flex items-center gap-4 group">
          <div className="flex items-center gap-3">
            <div className="px-2 py-1 border border-cyan-400/50 rounded bg-cyan-400/5 text-cyan-400 font-black text-xs md:text-sm tracking-tighter group-hover:border-orange-500/50 group-hover:text-orange-500 transition-all duration-500">
              RH.DEV
            </div>
            <div className="hidden sm:block h-4 w-[1px] bg-zinc-700"></div>
            <span className="hidden sm:inline-block text-xs md:text-sm font-bold tracking-[0.3em] text-white uppercase italic group-hover:text-cyan-400 transition-colors">
